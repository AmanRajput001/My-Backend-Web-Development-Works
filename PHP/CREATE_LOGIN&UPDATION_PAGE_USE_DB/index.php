...
<body>
    <div class="d-flex justify-content-center m-2">
        <form action=<?php echo $_SERVER["PHP_SELF"]; ?> method="post" class="card flex-column align-items-center form w-50 p-3 bg-dark rounded-5">
            <div class="display-5 text-light bg-primary text-center fw-bold rounded-5 rounded-bottom w-100 p-3">Log In</div>
            ...
            <a href="sign.php" class="text-end text-light m-2">SIGN IN</a>
        </form>
    </div>
            ...
            if (!(empty($_POST["username"]) || empty($_POST["password"]))) {
                echo '
                    <div class="d-flex justify-content-center">
                        <div class="display-5 text-light bg-success text-center rounded-2 w-100 p-3">Login Succesfull.</div>
                    </div>
                ';
